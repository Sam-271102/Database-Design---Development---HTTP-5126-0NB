-- Samuel Roy Jojo	ASSIGNMENT 3 FILTER DATA
-- Put your answers on the lines after each letter. E.g. your query for question 1A should go on line 5; your query for question 1B should go on line 7...
-- 1 
-- A
SELECT * FROM employees WHERE role= 'Manager' OR role= 'Assisstant';
-- B
...
-- B
SELECT item,price inventory FROM stock_items WHERE category = 'Canine' AND price BETWEEN 10 AND 20;
-- 4
-- A
SELECT first_name, last_name, phone FROM employees WHERE role NOT IN ('Manager', 'Assissant');
-- B
