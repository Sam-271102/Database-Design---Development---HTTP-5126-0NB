--  <SAMUEL ROY>	ASSIGNMENT 2 ACCESSING DATA PART 1
...
-- B
SELECT item AS name, id, inventory AS current_inventory FROM stock_items WHERE inventory <= 12;

--  5
-- A
SELECT item AS "Kitty Cat", price FROM stock_items WHERE category = 'Feline'
-- B
SELECT CONCAT(first_name,' ',last_name) AS "Staff Members" FROM employees WHERE id = 115